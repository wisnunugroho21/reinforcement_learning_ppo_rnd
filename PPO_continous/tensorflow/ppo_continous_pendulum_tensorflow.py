...
class Actor_Model(Model):
    def __init__(self, state_dim, action_dim):
        ...
        self.layer_actor_out = Dense(action_dim, activation='tanh', name = 'a3')
...
class Agent:  
    def __init__(self, state_dim, action_dim, is_training_mode):        
        ...
        self.cov_mat = tf.fill((action_dim,), action_std * action_std)
    ...
    def save_weights(self):
        self.actor.save_weights('pendulum_weights/actor.hd5')
        self.actor_old.save_weights('pendulum_weights/actor_old.hd5')
        self.critic.save_weights('pendulum_weights/critic.hd5')
        self.critic_old.save_weights('pendulum_weights/critic_old.hd5')
        
    def load_weights(self):
        self.actor.load_weights('pendulum_weights/actor.hd5')
        self.actor_old.load_weights('pendulum_weights/actor_old.hd5')
        self.critic.load_weights('pendulum_weights/critic.hd5')
        self.critic_old.load_weights('pendulum_weights/critic_old.hd5')
